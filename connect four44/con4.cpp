...
int win1_Count = 0, win2_Count = 0, tie_Count = 0, player1_Score = 0, player2_Score = 0, Rounds = 1, tie = 0;
...
void history() {
	...
	if (tie > 0) {
		game_Scoreboard << "Tied " << tie << " times." << endl;
	}
...
void historyShow() 
{
	...
	cout << "You have played: " << Rounds << " Rounds." << endl;
	cout << Player1Name << " Won " << player1_Score << " times." << endl;
	cout << Player2Name << " Won " << player2_Score << " times." << endl;
	if (tie > 0) {
		cout << "Tied " << tie << " times." << endl;
	}
	if (player1_Score>player2_Score) {
		cout << Player1Name << " is the winner of this game." << endl << endl << endl;
	}
	else if (player1_Score<player2_Score) {
        cout << Player2Name << " is the winner of this game." << endl << endl << endl;
	}
	else
...
void gameOperation() {
	...
	while (1)
	{
		...
		again1: cin.clear();
			...
			{
				cout << " INVALID CHOICE ENTER Y OR N PLEASE !!\n";
				goto again1;
			}
		}
		Player2Drop();
